...
def save_input_file(name, output_directory):
    ...
    #               'eleProperties',
    #               'eleTransf',
    #               'recorders']#, 'nodeLoads', 'loadCases', 'recorders']
    # input_wb = xl.load_workbook(name, keep_vba=False, data_only=True, read_only=True)
    # out_wb = xl.Workbook()
    ...
    shutil.copy(name, 'out/' + output_directory)
